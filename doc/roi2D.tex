...
\centering
 \subfigure[~]{
  \includegraphics[width=0.3\textwidth]{a_polyline.png}
  \label{f:polyline}
 }
...
\centering
 ...
 \caption{After refinement step, level 3, 5, 7.}
\label{fig:refined}
\end{figure}

%---------------------------
\subsection{Balanced mesh}
...
\centering
 ...
 \caption{After balancing step, level 3, 5, 7.}
\label{fig:balanced}
\end{figure}


%---------------------------
\subsection{Project interior points close to boundary}
...
\centering
 ...
 \caption{After projecting interior points close to boundary, level 3, 5, 7.}
\label{fig:projectinteriorcloseto}
\end{figure}

%---------------------------
\subsection{Remove on input surface}
...
\centering
 ...
 \caption{After safely removing exterior quadrants, level 3, 5, 7.}
\label{fig:removesurface}
\end{figure}


%---------------------------
\subsection{Surface Patterns}
...
\centering
 ...
 \caption{After applying surface patterns, level 3, 5, 7.}
\label{fig:surfacepatterns}
\end{figure}

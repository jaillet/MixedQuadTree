 ...
 */
/**
* @file CustomSplitVisitorV3.h
* @author Claudio Lobos, Fabrice Jaillet
* @version 0.1
* @brief
**/

#ifndef CustomSplitVisitorV3_h
#define CustomSplitVisitorV3_h 1
...
namespace Clobscode
{
    class CustomSplitVisitorV3 : public Visitor {

    public:

        CustomSplitVisitorV3();

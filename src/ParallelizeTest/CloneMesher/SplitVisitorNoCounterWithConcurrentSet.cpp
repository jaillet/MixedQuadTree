 ...
 */
/**
* @file SplitVisitorNoCounterWithConcurrentSet.cpp
...
//vector<vector<Point3D> > *clipping;
    ...
    SplitVisitorNoCounterWithConcurrentSet::SplitVisitorNoCounterWithConcurrentSet()
        :points(NULL),new_pts(NULL),edges(NULL),new_eles(NULL),clipping(NULL)
    { }

    void SplitVisitorNoCounterWithConcurrentSet::setPoints(const vector<MeshPoint> &points) {
        this->points = &points;
    }
    ...
    void SplitVisitorNoCounterWithConcurrentSet::setEdges(tbb::concurrent_unordered_set<QuadEdge, std::hash<QuadEdge>> &edges) {
        this->edges = &edges;
    }
    
    void SplitVisitorNoCounterWithConcurrentSet::setNewEles(vector<vector<unsigned int> > &new_eles) {
        this->new_eles = &new_eles;
    }
    
    void SplitVisitorNoCounterWithConcurrentSet::setClipping(vector<vector<Point3D> > &clipping) {
        this->clipping = &clipping;
    }

    bool SplitVisitorNoCounterWithConcurrentSet::visit(Quadrant *o)
    {
...
//--------------------------------------------------------------------------------
    ...
    bool SplitVisitorNoCounterWithConcurrentSet::splitEdge(unsigned int idx1, unsigned int idx2,
...
//--------------------------------------------------------------------------------
    ...
    /*bool SplitVisitorNoCounterWithConcurrentSet::splitFace(unsigned int idx1, unsigned int idx2,
